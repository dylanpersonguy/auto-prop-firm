...
export function Navbar() {
  ...
  return (
    <nav className="border-b border-white/[0.06] bg-gray-950/70 backdrop-blur-xl sticky top-0 z-50" aria-label="Main navigation">
      ...
      {/* Mobile menu */}
      {mobileOpen && (
        <div id="mobile-nav-menu" className="md:hidden border-t border-white/[0.06] bg-gray-950/95 backdrop-blur-xl" role="menu">
